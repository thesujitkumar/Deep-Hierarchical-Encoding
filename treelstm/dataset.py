...
class Dataset(data.Dataset):
    def __init__(self, path, vocab, num_classes):
        ...
        self.lsentences, self.lsentences_word = self.read_sentences(os.path.join(path, 'a.toks'))
        self.rsentences, self.rsentences_word = self.read_sentences(os.path.join(path, 'b.toks'))
