...
class Word2VecFeatureGenerator(FeatureGenerator):
    ...
    def process(self, df):
        ...
        print('Headline_unigram_array:', Headline_unigram_array)
        print(Headline_unigram_array.shape, type(Headline_unigram_array))
        ...
        print('headlineVec:', headlineVec )
        print('type(headlineVec)', type(headlineVec))
        ...
        print('Body_unigram_array:',  Body_unigram_array)
        ...
        print('bodyVec',  bodyVec, bodyVec.shape)
